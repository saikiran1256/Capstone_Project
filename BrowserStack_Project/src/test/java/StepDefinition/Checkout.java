...
public class Checkout {
	...
	@When("click on signin link and then sign in with signin credentials")
	public void click_on_signin_link_and_then_sign_in_with_signin_credentials() {
	...
	@Then("lastly close browser")
	public void lastly_close_browser() {
	    driver.close();
