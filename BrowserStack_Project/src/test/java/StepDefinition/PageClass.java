...
public class PageClass {
    ...
    public void AddressInfo() {
        wait.until(ExpectedConditions.visibilityOfElementLocated(firstName)).sendKeys("Thotakuri");
        wait.until(ExpectedConditions.visibilityOfElementLocated(lastName)).sendKeys("Sai Kiran");
        wait.until(ExpectedConditions.visibilityOfElementLocated(address)).sendKeys("Uppal,Hyderabad");
        wait.until(ExpectedConditions.visibilityOfElementLocated(province)).sendKeys("Telangana");
        wait.until(ExpectedConditions.visibilityOfElementLocated(postCode)).sendKeys("500039");
    }
    ...
    public void NewsletterEmail() {
        wait.until(ExpectedConditions.visibilityOfElementLocated(newsletterEmail)).sendKeys("abc123@gmail.com");
    }
